...
"}")
        ...
        self.pass_due_anal = QFrame(self.frame_24)
        ...
        self.horizontalLayout_3.addWidget(self.pass_due_anal)

        self.completed_anal = QFrame(self.frame_24)
        ...
        self.horizontalLayout_3.addWidget(self.completed_anal)
